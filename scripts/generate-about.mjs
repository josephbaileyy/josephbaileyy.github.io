...
<html lang="en">
  ...
  <body>
    ...
    <nav class="section-nav" aria-label="Portfolio sections">
      <a href="#current">Current</a><a href="#scale">Scale</a><a href="#research">Research</a><a href="#experience">Experience</a><a href="#projects">Projects</a><a href="#socials">Socials</a><a href="#education">Education</a><a href="#beyond">Beyond</a>
    </nav>
    <main>
      <header>
